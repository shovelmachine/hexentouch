...
// ARFIXME
#include <ctype.h>
static char *strupr( char *str ) { while(*str) { *str++ = toupper(*str); } return str; }
#endif
...
typedef enum
{
	...
	KEY_8,
	KEY_9,
	KEY_AX, //rww begin rww end
	KEY_BX, //rww begin rww end
	NUMKEYS
} keytype_t;
...
//rww begin
#if 1 
//DSFIXME write some arm for these
#ifdef _HEXENDS
	int HexenDivInt(int a, int b); //arm
	#define HexenDivIntU(a, b) (a/b)
	//#define FixedMul(a,b) ((fixed_t) (((float)(a) * (float)(b)) / FRACUNIT))
	fixed_t FixedMul(fixed_t a, fixed_t b); //arm

	//#define FixedDiv2(a,b) ((fixed_t) (((float)(a) / (float)(b)) * FRACUNIT))
	fixed_t FixedDiv2(fixed_t a, fixed_t b); //arm
	...
	*/
	fixed_t FixedDiv(fixed_t a, fixed_t b); //arm
#else
// AREIS BEGIN
#ifdef _IPHONE
	inline static int HexenDivInt(int a, int b) { return a / b; }
	inline static unsigned int HexenDivIntU(unsigned int a, unsigned int b) { return a / b; }
#else
...
// AREIS BEGIN
	...
	#define FixedMul(a,b) ((fixed_t) (((float)(a) * (float)(b)) / FRACUNIT))
#else
	static __inline fixed_t FixedMul(int a, int b)
	{
		fixed_t r;
		__asm {
			mov		eax, a
	...
	#define FixedDiv2(a,b) ((fixed_t) (((float)(a) / (float)(b)) * FRACUNIT))
#else
	static __inline fixed_t FixedDiv2(int a, int b)
	{
		fixed_t r;
	...
	static __inline fixed_t FixedDiv(fixed_t a, fixed_t b)
	{
		if((abs(a)>>14) >= abs(b))
		{
			return((a^b)<0 ? MININT : MAXINT);
...
} STRUCTSPACKEDNOT memblock_t;

#ifdef _ZONE_TRIMMING
...
#define DRAWSCREENWIDTH		320
#define DRAWSCREENHEIGHT	200
...
#define	SCREENWIDTH			320
#define	SCREENHEIGHT		200
#define DRAWSCREENWIDTH		SCREENWIDTH
#define DRAWSCREENHEIGHT	SCREENHEIGHT
#endif
//rww end
#else
