...
drawseg_t       drawsegs[MAXDRAWSEGS] MODULE_DTCM_DATA, *ds_p;
...
{
	int     first, last;
} STRUCTSPACKEDNOT cliprange_t;

#define MAXSEGS 32

cliprange_t     solidsegs[MAXSEGS] MODULE_DTCM_DATA, *newend;    // newend is one past the last valid seg
