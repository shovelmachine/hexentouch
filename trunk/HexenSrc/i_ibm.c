...
//rww begin
// AREIS BEGIN
#if !defined( _HEXENDS ) && !defined( _IPHONE )
...
#elif defined( _IPHONE )
extern void iPhone_ScreenUpdate( int subchanged );
#else
...
#elif defined( _IPHONE )
	iPhone_ScreenUpdate( subchanged );
#else
	Win32_WindowUpdate();
